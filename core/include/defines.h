...
// Tile constants.
#define TILE0_DATA_START 0x8800
#define TILE0_DATA_END 0x97FF
#define TILE1_DATA_START 0x8000
#define TILE1_DATA_END 0x8FFF
...
#define TILE_DATA_START TILE1_DATA_START
#define TILE_DATA_END TILE0_DATA_END + 1
const int TILES_PER_BANK = (TILE_DATA_END - TILE_DATA_START) / BYTES_PER_TILE;
const int TILES_PER_BANK_THIRD = TILES_PER_BANK / 3;
